...
class Heikin_Ashi1D51SHORT_ONLY(IStrategy):
    INTERFACE_VERSION = 3
    ...
    buy_RSI_long = IntParameter(30, 60, default=55, space="buy")
    buy_RSI_short = IntParameter(30, 60, default=46, space="buy")
    buy_cust_one_trade_limit_max = IntParameter(5, 30, default=23, space="buy")
