...
class ERMD_Strategy_amount_4h_240(IStrategy):
    ...
    buy_total_risk_trade = DecimalParameter(0.007, 0.025, decimals=3, default=0.021, optimize=True)
    ...
    buy_ema1_length = IntParameter(3, 100, default=7, optimize=True)
    buy_ema2_length = IntParameter(3, 100, default=59, optimize=True)
    buy_ema3_length = IntParameter(3, 100, default=29, optimize=True)
    buy_rsi_enabled = BooleanParameter(default=True, optimize=True)
    buy_rsi_length = IntParameter(3, 100, default=42, optimize=True)
    buy_rsi_threshold = IntParameter(50, 100, default=67, optimize=True)
    buy_macd_enabled = BooleanParameter(default=False, optimize=True)
    buy_macd_fast = IntParameter(3, 50, default=4, optimize=True)
    buy_macd_slow = IntParameter(20, 200, default=113, optimize=True)
    buy_macd_smooth = IntParameter(1, 30, default=14, optimize=True)
    ...
    sell_ema1_length = IntParameter(3, 100, default=28, optimize=True)
    sell_ema2_length = IntParameter(3, 100, default=84, optimize=True)
    sell_ema3_length = IntParameter(3, 100, default=30, optimize=True)
    sell_rsi_enabled = BooleanParameter(default=True, optimize=True)
    sell_rsi_length = IntParameter(3, 100, default=74, optimize=True)
    sell_rsi_threshold = IntParameter(0, 50, default=29, optimize=True)
    sell_macd_enabled = BooleanParameter(default=False, optimize=True)
    sell_macd_fast = IntParameter(3, 50, default=22, optimize=True)
    sell_macd_slow = IntParameter(20, 200, default=97, optimize=True)
    sell_macd_smooth = IntParameter(1, 30, default=27, optimize=True)
    ...
    sell_low_line = IntParameter(-100, -75, default=-85, space="sell", optimize=True)
    sell_ema = IntParameter(7, 22, default=7, space='sell', optimize=True)
    sell_willy = IntParameter(15, 30, default=28, space='sell', optimize=True)
    buy_sl_mult = DecimalParameter(0.5, 5, default=3.0, decimals=1, space='buy', optimize=True)
