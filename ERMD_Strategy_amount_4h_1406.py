...
class ERMD_Strategy_amount_4h_1406(IStrategy):
    ...
    buy_total_risk_trade = DecimalParameter(0.007, 0.025, decimals=3, default=0.009, optimize=True)
    ...
    buy_ema1_length = IntParameter(3, 100, default=23, optimize=True)
    buy_ema2_length = IntParameter(3, 100, default=35, optimize=True)
    buy_ema3_length = IntParameter(3, 100, default=93, optimize=True)
    buy_rsi_enabled = BooleanParameter(default=False, optimize=True)
    buy_rsi_length = IntParameter(3, 100, default=50, optimize=True)
    ...
    buy_macd_fast = IntParameter(3, 50, default=49, optimize=True)
    buy_macd_slow = IntParameter(20, 200, default=159, optimize=True)
    ...
    sell_ema1_length = IntParameter(3, 100, default=99, optimize=True)
    sell_ema2_length = IntParameter(3, 100, default=78, optimize=True)
    sell_ema3_length = IntParameter(3, 100, default=88, optimize=True)
    sell_rsi_enabled = BooleanParameter(default=False, optimize=True)
    sell_rsi_length = IntParameter(3, 100, default=26, optimize=True)
    sell_rsi_threshold = IntParameter(0, 50, default=25, optimize=True)
    sell_macd_enabled = BooleanParameter(default=False, optimize=True)
    sell_macd_fast = IntParameter(3, 50, default=29, optimize=True)
    sell_macd_slow = IntParameter(20, 200, default=52, optimize=True)
    ...
    sell_high_line = IntParameter(-25, 0, default=-11, space="sell", optimize=True)
    sell_low_line = IntParameter(-100, -75, default=-92, space="sell", optimize=True)
    sell_ema = IntParameter(7, 22, default=19, space='sell', optimize=True)
    sell_willy = IntParameter(15, 30, default=18, space='sell', optimize=True)
    buy_sl_mult = DecimalParameter(0.5, 5, default=4.3, decimals=1, space='buy', optimize=True)
